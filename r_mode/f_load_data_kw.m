...
function [raw_data, Acq]= f_load_data_kw(Para)

load([Para.datapath,Para.dataname]);
Acq.fs = 1/6e-7; %5e6; % sampling rate
...
raw_data = single(sensor_data_all);
clear sensor_data_all
